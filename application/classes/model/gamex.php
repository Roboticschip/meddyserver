...
abstract class Model_Gamex extends ORM { // ActiveRecord\Model {
...
/** dynamic finder with the given condition-array  */
	...
	public static function create_model($classname, $values, $version, $missing_delimeter, &$updated_classes){
		...
		//$insertstatus = $modelname::create(array("title" => $title , "message" => $message));
			
		
	}
	public static function create_model1($classname, $values, $version, $missing_delimeter, &$updated_classes){
